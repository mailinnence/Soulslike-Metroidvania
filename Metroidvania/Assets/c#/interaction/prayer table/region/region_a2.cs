...
public class region_a2 : prayerTableManager
{
    // region_A1 로 가정
    ...
    void save_init()
    {
        ...
        if (File.Exists(path))
        {
            ...
            if (File.Exists(playerPath))
            {
                ...
                // 씬 초기화 ---------------------------------------------
                playerData.save_Scene = "1_1";

                // 지역 초기화 ---------------------------------------------
                playerData.save_Location = "왕실의 안뜰 살레라스";
    ...
    void save_coordinate()
    {
        ...
        if (File.Exists(path))
        {
            ...
            if (File.Exists(playerPath))
            {
                ...
                playerData.save_coordinate.Add(188.33f);
                playerData.save_coordinate.Add(-47.67002f);
