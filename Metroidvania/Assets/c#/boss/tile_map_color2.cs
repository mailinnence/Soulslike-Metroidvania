...
public class tile_map_color2 : playerStatManager
{
    ...
    public Tilemap tilemap8;
    public Tilemap tilemap9;
    public Tilemap tilemap10;
    public Tilemap tilemap11;
    ...
    public void Background_Out()
    {
        ...
        tilemap8.color = newColor;
        tilemap9.color = newColor;
        tilemap10.color = newColor;
        tilemap11.color = newColor;
